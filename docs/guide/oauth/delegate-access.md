...
Send a `POST` request to `https://directory.zaikio.com/oauth/delegate` with the generated access token provided in the `Authorization` header. The following parameters must accompany the request:
